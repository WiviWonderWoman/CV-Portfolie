...
document.getElementById('edu').addEventListener('click', function(){
    document.getElementById('content'). innerHTML = `<h2>Utbildningar</h2>
    <!--Table for displaying data about education-->
    <table>
        <tr>
            <td>Vård & omsorg</td>
            <td>Petri Vårdgymnasium</td>
            <td>1992</td>
            <td>1993</td>
        </tr>
        <tr>
            <td>Koplettering, tredje året</td>
            <td>Komvux</td>
        ...
        <tr>
            ...
            <td rowspan="3">Hermods</td>
            <td rowspan="3" colspan="2">2020</td>
        </tr>
        <tr>
            <td>Matematik 2a</td>
        </tr>
...
document.getElementById('content'). innerHTML = `<h2>Arbetslivserfarenhet</h2>
    <!--Table for displaying data about work-->
    <table>
        <tr>
            <td>Labratoriediskare</td>
            <td>KM Labratorierna AB</td>
            <td>1990</td>
            <td>1991</td>
        </tr>
        <tr>
            <td>Industriarbetare</td>
            <td>Höganäs Keramik AB</td>
            <td>1998</td>
            <td>2004</td>
        </tr>
        <tr>
            <td rowspan="2">Undersköterska</td>
        ...
        <tr>
            <td rowspan="2">Lokalvårdare</td>
            <td>Tydingesjöns Camping</td>
...
document.getElementById('content'). innerHTML = ` <h2>Ideella Uppdrag</h2>
            
        <p>Som ensamstående förälder till fem barn (födda 1996, 1999, 2000, 2006 samt 2008), nästan alla har vi olika grad av funktionsvarianter så är jag van att ha många bollar i luften. Jag brukar lite skämtsamt säga att jag har många bisysslor: specialpedagog, samordnare, metodhandledare, debattör, sekreterare, dietist, arbetsterapeut, medlare, processhandledare, jurist, ekonomiassistent och städerska… 
            Jag har genom åren gått alla patient- och anhörigutbildningar, alla ålders kategorier, som Region Skåne erbjuder för angående adhd och autism. Vilket har gett mig mycket kunskap i olika strategier för både kognitiva och exekutiva svårigheter och på köpet om hur hjärnan fungerar i allmänhet.</p>
...
document.getElementById('content'). innerHTML = `<h2>Intressen</h2>
        ...
        <div id="hobbyPic" class="flex-container">
            <ul>
                ...
                <li><img src="./Kock.jpg" alt="photo of my son, as a crocheted doll with chef outfit" ></li>
            </ul>
        </div>`
});

document.getElementById('sum').addEventListener('click', function(){
document.getElementById('content'). innerHTML = `<h2>Summering</h2>

        <p>Jag har under många år haft en självkänsla långt under genomsnittet, både på grund av yttre och inre omständigheter. De senaste åren har jag jobbat hårt med min personliga utveckling, självbild och självförtroende. Jag har reflekterat, korrigerat och balanserat mig själv och mitt liv. Jag försöker strunta i jantelagen så numera kommer jag på mig själv att vara stolt över vem jag är och vad jag åstadkommer. Jag har fått höra av min omgivning att jag är en ”super-mamma” som fixar allt, att jag är bra på många olika saker och att jag överraskar med mina kunskaper inom vitt spridda områden.</p>
